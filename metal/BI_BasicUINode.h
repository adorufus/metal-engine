...
namespace BI
{
	...
	class BI_BasicUINode : public NUIE::UINode
	{
		SERIALIZABLE;
	...
	private:
		...
		virtual void						UpdateDrawingImage(NUIE::NodeUIDrawingEnvironment& env, NUIE::NodeDrawingImage& drawingImage) const override;
